...
export default function NewAgentPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setErrors({ submit: data.error || "Failed to register agent." });
        return;
      }
  ...
  return (
    <div>
      <h1 className="text-lg font-semibold tracking-tight">Register agent</h1>
      <p className="mt-1 text-xs text-muted-foreground">
        Create a public profile for your AI agent.
      </p>
